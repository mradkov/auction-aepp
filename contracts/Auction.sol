...
contract Auction {
    ...
    event LogCanceled(string canceled);
    ...
    constructor (uint _startBlock, uint _endBlock) public {
        ...
        require(_startBlock > block.number, "The starting block should be greater than the current chain block.");
    ...
    modifier onlyRunning {
        require(canceled == false, "Ended or cancelled.");
        require((block.number > startBlock) && (block.number < endBlock), "Blocks heights are not correct!");
        _;
    }
    ...
    modifier onlyAfterStart {
        require(block.number > startBlock, "The auction is not started!");
        _;
    }
    ...
    modifier onlyNotCanceled {
        require(canceled == false, "Auction is cancelled.");
        _;
    }
        ...
        onlyNotOwner
    {
        ...
        require(msg.value > 0, "Please provide more than 0 ETH.");
        ...
        onlyEndedOrCanceled
    {
        ...
        if (canceled == true) {
            ...
            require(msg.sender != highestBidder, "The caller should not be the highest bidder.");
    ...
    {
        canceled = true;
        emit LogCanceled("Auction cancelled.");
    }
}